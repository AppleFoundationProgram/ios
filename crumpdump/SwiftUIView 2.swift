...
//  crumpdump
//
//  Created by foundation program on 10/14/24.
//
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            .sheet(isPresented: $isImageSheetPresented) {
                ImageSheetView() // 이미지 Sheet에 표시될 내용
            }
        }
